...
const grabData = async function(city) {
  ...
  const filterData = function(data) {
    ...
    const sunrise = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_0__.default)(new Date((0,date_fns_toDate__WEBPACK_IMPORTED_MODULE_1__.default)(data.sys.sunrise)), 'h:mmaaa');
    const sunset = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_0__.default)(new Date((0,date_fns_toDate__WEBPACK_IMPORTED_MODULE_1__.default)(data.sys.sunset)), 'h:mmaaa');
